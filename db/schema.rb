...
ActiveRecord::Schema[7.1].define(version: 2024_06_05_030329) do
  ...
  create_table "movie_copies", force: :cascade do |t|
    ...
    t.index ["order_id"], name: "ix_movie_copies_on_order_id"
  end
  ...
  create_table "user_ratings", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "ix_user_ratings_on_user_id"
  end
