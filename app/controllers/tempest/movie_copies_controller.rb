class Tempest::MovieCopiesController < AdminController
  ...
  def index
    ...
    @movie_copies = apply_scopes(@movie_copies.includes(:order))
  ...
  def create
    ...
    logger.debug "Order Params: #{movie_copy_params.inspect}"
    logger.debug "Order Errors: #{@movie_copy.errors.full_messages}" unless @movie_copy.valid?
