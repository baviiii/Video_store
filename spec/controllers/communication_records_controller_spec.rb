  ...
  describe 'POST create' do
    ...
    it 'creates a communication_record' do
      expect {
        create(:communication_record) }.to change(CommunicationRecord, :count).by(1)
    end
  end
  ...
  describe 'POST update' do
    ...
    it 'updates the record' do
      communication_record = create(:communication_record)
      put :update, params:{ id: communication_record.to_param, communication_record: attributes_for(:communication_record) }
